...
function init() {
    ...
    // Planet
    // const texturePlanet = loader.load('pawel-czerwinski-_Ycx-1p6Gyg-unsplash.jpg');
    ...
    //Moon
    const textureMoon = loader.load('https://images.unsplash.com/photo-1632835837413-890dd1af57d2?auto=format&fit=crop&w=500');
